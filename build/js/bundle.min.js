...
var missions = [
  "ut cupidatat fugiat culpa",
  "non cupidatat cupidatat ad",
  "amet fugiat adipisicing qui",
  "voluptate eu mollit sint",
  "cillum aliqua eu id",
  "nostrud duis elit veniam",
  "nostrud velit sunt sunt",
  "fugiat aliquip fugiat duis",
  "enim exercitation aute in",
  "aliqua tempor minim irure",
  "veniam dolor nisi sint",
  "proident aute aute consequat",
  "tempor pariatur proident id",
  "duis sint elit enim",
  "est do labore anim"
]

var missions_cina = [
	"Get RF chip implanted",
	"Build a black bath bomb",
	"Secret movie society",
	"Roman candle fight",
	"Get banned from a church",
	"Open an underground bar / night cafe",
	"Snow sculptures",
	"1k origami cranes	",
	"Organize a real slumber party",
	"Get RF chip implanted",
	"Build a tiny yellow smiley face bomb",
	"Color fight in an abandoned building",
	"Get RF chip implanted",
	"Get a hedgehog and name him Fudge",
	"Try all Ben and Jerry’s flavours"
]
